...
//semt menu variants
global.vidmenu = fs.readFileSync("./dark-lion-media/theme/Cheems-bot.mp4") //gif and video menu
...
//Bot theme media
global.thum = fs.readFileSync("./dark-lion-media/theme/cheemspic.jpg") //ur thumb pic
global.log0 = fs.readFileSync("./dark-lion-media/theme/cheemspic.jpg") //ur logo pic
global.err4r = fs.readFileSync("./dark-lion-media/theme/cheemspic.jpg") //ur error pic
global.thumb = fs.readFileSync("./dark-lion-media/theme/cheemspic.jpg") //ur thumb pic
...
global.thumb = fs.readFileSync('./dark-lion-media/theme/cheemspic.jpg')
